...
import net.mcreator.theelderscrollscraft.block.SasaOreBlock;
...
public class TheElderScrollsCraftModBlocks {
	...
	public static final RegistryObject<Block> SASA_ORE = REGISTRY.register("sasa_ore", () -> new SasaOreBlock());
